	...
	<form class="msg-form" @submit.prevent="handleSubmit">
		<div class="msg-form-header">
			<div class="msg-form-title">
				...
				<span>FTLP Merge Form</span>
			</div>
			<p class="msg-form-description">
				Configure FTLP Merge parameters and submit the transaction.
			</p>
		</div>
		...
		<div class="form-item-btn-container">
			<button class="form-button-submit" type="submit" :disabled="!isFormValid || isSubmitting">
				...
				<span v-else>Send FTLP Merge</span>
			</button>
		</div>
	</form>
...
const handleSubmit = async () => {
	...
	try {
		...
		console.log('FTLP_MERGE Generated Data:', params);
		...
		const errorMsg =
			error instanceof Error ? error.message : 'Failed to send FTLP Merge transaction';
